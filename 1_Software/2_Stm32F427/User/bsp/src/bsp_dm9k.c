...
*   参  数: 无
*   返  回: 无
*   功  能: 配置DM9000AE控制口线，FMC管脚设置为复用功能
*/
...
void DM9K_FMCConfig(void)
{
    ...
    /*----------------------- SRAM Bank 3 ----------------------------------------*/
    /*-- FMC Configuration ------------------------------------------------------*/
    p.FMC_AddressSetupTime = 5;        /* 设置为2会出错; 3正常 */
    p.FMC_AddressHoldTime = 1;
    p.FMC_DataSetupTime = 10;          /* 设置为1出错，2正常 */
    ...
    FMC_NORSRAMInitStructure.FMC_MemoryType = FMC_MemoryType_SRAM;   // FMC_MemoryType_PSRAM;
